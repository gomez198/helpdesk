...
--
-- Host: localhost:3306
-- Generation Time: May 20, 2022 at 09:28 AM
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `ibfk_user_1` FOREIGN KEY (`is_active`) REFERENCES `active` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
